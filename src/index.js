...
const logSuccess = (resolveArr) => {
    console.log(`Transaction ${ resolveArr[0] } processed in ${ resolveArr[1] }ms`);
...
//  * Должно работать так
//  */
makeTransaction({ id: 70, amount: 130 })
    .then(logSuccess)
    .catch(logError);
